...
public class CategoryManageController {
    ...
    @ResponseBody
    public ServerResponse addCategory(HttpServletRequest httpServletRequest
            ,String categoryName
...
//        }
    ...
    @ResponseBody
    public ServerResponse setCategoryName(HttpServletRequest httpServletRequest
            ,Integer categoryId
            ,String categoryName){
//
//        String loginToken = CookieUtil.readLoginToken(httpServletRequest);
...
//        }
    ...
    //获取当前categoryId下面一级平级的所有子节点category信息，不递归
